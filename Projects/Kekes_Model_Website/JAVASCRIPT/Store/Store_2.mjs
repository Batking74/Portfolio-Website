...
img[0] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_1.jpg`;
img[1] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_2.jpg`;
img[2] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_3.jpg`;
img[3] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_4.jpg`;
img[4] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_5.jpg`;
img[5] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_6.jpg`;
img[6] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_7.jpg`;
img[7] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_8.jpg`;
img[8] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_9.jpg`;
img[9] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_10.jpg`;
img[10] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_11.jpg`;
img[11] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_12.jpg`;
img[12] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_13.jpg`;
img[13] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_14.jpg`;
img[14] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_15.jpg`;
img[15] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_16.jpg`;
img[16] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_17.jpg`;
img[17] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_18.jpg`;
img[18] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_19.jpg`;
img[19] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_20.jpg`;
img[20] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_21.jpg`;
img[21] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_22.jpg`;
img[22] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_23.jpg`;
img[23] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_24.jpg`;
img[24] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_25.jpg`;
img[25] = `${navStoreBlueprint[i2.path]}/IMG/Store Products/Store 2/Product_4.jpg`;

description[0] = 'Black Lives Matter T-Shirt';
description[1] = 'Black Lives Matter Wristbands (5 Count)';
description[2] = 'Black Lives Matter Souvenir, Power Fist Bronze Material';
description[3] = 'Black Lives Matter T-Shirt';
...
productLink[25] = `${navStoreBlueprint[i2.path]}/HTML/Store/Page 2/product_25.html`;
